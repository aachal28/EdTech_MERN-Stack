...
const Home = () => {
    ...
    useEffect(() => {
        // setBackgroundImg(backgroundImg1); 
    ...
    const categoryID = "660fc8fcd2377125ea97a28c" // hard coded
        ...
        <React.Fragment>
            ...
            <div className=' '>
                ...
                <div className='relative h-[450px] md:h-[550px] justify-center mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white '>
                    ...
                    >
Explore our online coding courses, where you have the freedom to learn at your own pace, from any corner of the globe. Dive into a rich pool of resources, featuring hands-on projects, interactive quizzes, and personalized guidance from expert instructors.                    </motion.div>
                        ...
                        <div className='flex flex-col lg:flex-row gap-5 mb-10 mt-[95px]'>
                            ...
                            <div className='flex flex-col gap-10 w-full lg:w-[40%] items-start'>
                                <div className='text-[16px]'>
                                    The modern TheCodingGeeks is the dictates its own terms. Today, to be a competitive specialist requires more than professional skills.
                                </div>
                                <CTAButton active={true} linkto={"/signup"}>
                                    <div>
                                        Learn more
